	...
	*/
	...
	elseif(isset($_POST["edit-device-submit"])){
		...
		if($ok == true){
			...
			else echo "<div class='alert alert-danger'><strong>Virhe! Kannan rivien muokkaaminen epäonnistui...</strong></div>";
		}

		echo "<div class='alert alert-warning'><strong>Muokkausta ei suoritettu!<br/>Et valinnut yhtään laitetta!</strong></div>";
		...
		<div id='delete-device' class='collapse'>
			...
			<br/>
				<form action='' method='POST' enctype='multipart/form-data' id='device-delete'>
					<label>Etsi poistettavan tuotteen ean</label>
