	...
	if(isset($_GET["model"])) {
		...
		if($result = mysqli_query($conn, $query)) {
			if(mysqli_num_rows($result) > 0) {
				...
				$device_page .= "<h3 style='text-align:center;'><b>$model</b></h3><br/><br/><div class='col-md-4'><img class='img-responsive' src='images/device/$tmp_img' style='height:100%;max-height:285px;width:auto;'></div>";
				...
				if($result = mysqli_query($conn, $query)){
					...
					echo "<div class='col-md-8'><br/><label>Kuvaus</label>\n<br/><textarea readonly style='border:none;resize:none;width:100%;height:167px;background-color:#ededed;'>$row[description]</textarea><br/><br/></div>";
				}
				/*rows='7' cols='90'*/
				echo "<div class='row'><div class='col-md-12' style=''><br/><br/><form class='form-inline'> <p>Aloitus: &nbsp;&nbsp;<input type='text' class='datepicker form-control'> Klo: <select type='text' class='klo'>";
				...
				echo "</select></p><p>Lopetus: <input type='text' class='datepicker form-control'> Klo: <select type='text' class='klo'>";
				...
				echo "$hours\n</select></p></form></div></div><br/><br/><br/>";
