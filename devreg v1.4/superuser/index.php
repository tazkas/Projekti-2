			...
			if(mysqli_num_rows($result) > 0) {
				...
				foreach($devices as $d){
					...
					$page_main .= "<div class='col-md-4 col-xs-6'><div class='thumbnail'>" .
									...
									"<img src='images/device/$d[image]' class='rounded mx-auto d-block' alt='' style='height:100%;max-height:150px;width:auto;'>" . 
			...
			if(mysqli_num_rows($result) > 0) {
				...
				while($row = mysqli_fetch_assoc($result)) {
					...
					$page_main .= "<div class='col-md-4 col-xs-6'><div class='thumbnail'>" .
									...
									"<img src='images/category/$row[image]' class='rounded mx-auto d-block' alt='' style='padding-top:25px;height:100%;max-height:150px;width:auto;'>" . // FIX THE STYLE
									"<div class='caption text-center'>" . 
									"<p>$row[name]</p>" . 
									"</div></a></div></div>";
				}
