	...
	if(isset($_GET["model"])) {
		...
		if($result = mysqli_query($conn, $query)) {
			if(mysqli_num_rows($result) > 0) {
				...
				/*rows='7' cols='90'*/
				echo "<div class='row'><div class='col-md-12' style='overflow-y:hidden;'><br/><br/><form class='form-inline'> <p>Aloitus: &nbsp;&nbsp;<input type='text' class='datepicker form-control'> Klo: <select type='text' class='klo' id='klo1'>";
